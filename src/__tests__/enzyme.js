...
describe('React Player tests', () => {
  ...
  it('When the HTTP GET request in the Video Item Details Route is successful, then the page should consist of ReactPlayer from react-player:::5:::', async () => {
    mockGetCookie()
  ...
  it('When the HTTP GET request in the Video Item Details Route is successful, then the page should consist of ReactPlayer from react-player and url prop should be equal to the value of the key "video_url" received from the video details response:::5:::', async () => {
    mockGetCookie()
    window.history.pushState(
      {},
      'Test page',
