...
describe('Saved Videos Route Functionality tests', () => {
  beforeAll(() => {
    server.listen()
  })
  ...
  it('When the theme icon button in the Saved Videos Route is clicked, then the page should consist of an HTML image element in the Header with alt attribute value as "website logo" and src as given dark theme logo URL:::5:::', () => {
    mockGetCookie()
    renderWithBrowserRouter()
  ...
  it('When the theme icon button in the Saved Videos Route is clicked, then the page should change to dark theme and consist of the HTML container element with data-testid attribute value as "savedVideos" and background color as "#0f0f0f":::5:::', () => {
    mockGetCookie()
    renderWithBrowserRouter()
  ...
  it('When the theme icon button in the Saved Videos Route is clicked, and the Home link is clicked, then the page should be navigated to the Home Route, and the theme should remain the same:::5:::', async () => {
    mockGetCookie()
    renderWithBrowserRouter()
  ...
  it('When the Logout button in the Header of the Saved Videos Route is clicked, then the page should consist of Popup from reactjs-popup:::5:::', () => {
    mockGetCookie()
    renderWithBrowserRouter()
    userEvent.click(
  ...
  it('When the Logout button in the Header of the Saved Videos Route is clicked, then the page should consist of an HTML paragraph element with text content as "Are you sure you want to logout?":::5:::', () => {
    mockGetCookie()
    renderWithBrowserRouter()
    userEvent.click(
      screen.getByRole('button', {
  ...
  it('When the Logout button in the Header of the Saved Videos Route is clicked, then the page should consist of an HTML button element with text content as "Cancel":::5:::', () => {
    mockGetCookie()
    renderWithBrowserRouter()
    userEvent.click(
      screen.getByRole('button', {
  ...
  it('When the Logout button in the Header of the Saved Videos Route is clicked, then the page should consist of an HTML button element with text content as "Confirm":::5:::', () => {
    mockGetCookie()
    renderWithBrowserRouter()
    userEvent.click(
      screen.getByRole('button', {
  ...
  it('When the Logout Popup is opened and the Cancel button in the popup is clicked, then the page should not consist of Popup from reactjs-popup:::5:::', () => {
    mockGetCookie()
    renderWithBrowserRouter()
    userEvent.click(
      screen.getByRole('button', {
  ...
  it('When the Logout Popup is opened and the Confirm button in the popup is clicked, then the Cookies.remove() method should be called with the argument as "jwt_token":::5:::', () => {
    mockRemoveCookie()
    mockGetCookie()
    rtlRender(<App />)
  ...
  it('When the Logout Popup is opened and the Confirm button in the popup is clicked, then the history.replace() method should be called with the argument as "/login":::5:::', () => {
    mockRemoveCookie()
    mockGetCookie()
  ...
  it('When the Logout Popup is opened and the Confirm button in the popup is clicked, then the page should be navigated to the Login Route:::5:::', () => {
    mockGetCookie()
    mockRemoveCookie()
    renderWithBrowserRouter()
    const logoutBtn = screen.getByRole('button', {
